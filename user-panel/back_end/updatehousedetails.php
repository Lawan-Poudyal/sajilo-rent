...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $query = "UPDATE housedetails SET
               no_of_rooms = ? , no_of_roommates = ? , gates_open = ? , gates_close = ?, wifi_price = ? , 
               image1 = ? , image2 = ? , image3 = ? ,  price = ? , parking = ? , electricity = ? , floor_level = ? , house_facing_direction = ?
              WHERE username = ? and latitude=? and longitude = ?";
    ...
    $stmt->bind_param("iississsississdd", 

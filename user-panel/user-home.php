...
<body>
    ...
    <main class="main">
        ...
        <aside id="aside1"class="main-aside aside1">
            ...
            <div class="main-aside-div credentials">Owner</div>
        </div>
        ...
        <div class="main-div student-verification" id="student-verification">
            
            <form action="" class="student-verification-form">

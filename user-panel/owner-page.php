            ...
            <div class="form-div" id="js-form-div">
                <form class="house-info" method="POST" action="/sajilo-rent/user-panel/back_end/addhousedetails.php" enctype="multipart/form-data">
                    ...
                    <div class="house-facing-direction wrapper-div">
                        <label for="house-facing-direction">House Direction:</label>
                    ...
                    <div class="wifi wrapper-div">
                        <label for="wifi">Wifi (in NPR/month):</label>
                    ...
                    <div class="image wrapper-div">
                        <label for="image">Upload Three Images of the room:</label>
                ...
                <div class="cross-icon" id="js-cross-icon">
                    <img src="/sajilo-rent/resources/cross.png" alt="" height="50" width="50">
                </div>
            </div>
        </main>
    </div>

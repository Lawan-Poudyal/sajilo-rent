...
<head>
    ...
    <link rel="stylesheet" href="/sajilo-rent/user-panel/styles/user-home-style2.css">
...
<body>
    ...
    <main class="main">
        ...
        <aside id="aside2" class="main-aside aside2">
            ...
            <h3 class="main-aside-h3">Why Sajilo Rent</h3>
        ...
        <div class="main-div student-verification hidden" id="student-verification">
            <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST" class="student-verification-form">
                ...
                <div class="input-field">
                    ...
                    <input type="password" placeholder="Enter your password" class="password" name="password" id="password">
    ...
    <script src="/sajilo-rent/user-panel/script/user-home-script.js"></script>
